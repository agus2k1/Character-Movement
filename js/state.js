...
export class StandingLeft extends State {
    ...
    enter() { //When enters current state (Runs Once)
        this.player.frameY = 1;
        this.player.speed = 0;
        this.player.maxFrameX = 6;
    }
    handleInput(input) { //Swap to different state (Runs over and over)
...
export class JumpingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if (input === "RELEASE left") this.player.speed = 0;
    }
}
...
export class JumpingRight extends State {
    ...
    handleInput(input) {
        ...
        else if (input === "RELEASE right") this.player.speed = 0;
    }
}
